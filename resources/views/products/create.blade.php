				    ...
				    <div class="tab-content">
				        ...
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							<div class="form-group">
								...
								<div class="col-lg-9">
									<input type="text" class="form-control js_required" name="name" placeholder="{{__('Product Name In English')}}" onchange="update_sku()" >
								</div>
							</div>
							<div class="form-group">
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							...
							<div class="form-group">
								...
								<div class="col-lg-9">
									<input type="number" min="0" step="0.01" placeholder="{{__('Purchase price')}}" name="purchase_price"
									 class="form-control" >
								</div>
							</div>
                        	...
                        	<div class="form-group">
								...
								<div class="col-lg-9">
									<input type="number" min="0" step="0.01" placeholder="{{__('Quantity')}}" name="quantity"
									 class="form-control" >
								</div>
							</div>
...
<script type="text/javascript">
    ...
    function add_color_image(color_code=null, color_name=null){
        ...
        var color_html = `<tr class="tr_class" id="cid_`+tr_id+`">
                            ...
                            <td>
                                <input type="file" name="color_images[`+tr_id+`][]" class="form-control" placeholder="color images"  multiple>
                            </td>
                          </tr>`;
...
/*	function get_brands_by_subsubcategory(){
    ...
    $("body").on('click',"#js_submit_ajax",function(){
        ...
        local_valid = true; //check_validation();
